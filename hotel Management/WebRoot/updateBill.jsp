		...
		<div class="right">
			<form action="updateBill.do" method="post">
				<table class="table table-bordered">
					<tr>
						<td>账单编号</td>
						<td><input type="text" name="billid" value="${b.billid }" readonly>
						</td>
					</tr>
					<tr>
						<td>订单编号</td>
						<td><input type="text" name="userid" value="${b.res.dingdanid }" >
						</td>
					</tr>
					<tr>
						<td>天数</td>
						<td><input type="text" name="roomid" value="${b.day }" >
						</td>
					</tr>
					<tr>
						<td>金额</td>
						<td><input type="text" name="arrive" value="${b.money }" >
						</td>
					</tr>
